...
.method private writeFileHeader(Lnet/lingala/zip4j/model/ZipModel;Lnet/lingala/zip4j/model/FileHeader;Ljava/io/ByteArrayOutputStream;Lnet/lingala/zip4j/util/RawIO;Ljava/nio/charset/Charset;)V
    ...
    .line 409
    .local v10, "writeZip64ExtendedInfo":Z
    ...
    invoke-virtual {v5, v4, v11}, Lnet/lingala/zip4j/util/RawIO;->writeIntLittleEndian(Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {v5, v4, v11}, Lnet/lingala/zip4j/util/RawIO;->writeShortLittleEndian(Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {v5, v11, v8, v12, v13}, Lnet/lingala/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    invoke-virtual {v4, v11, v8, v12}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    ...
    invoke-virtual {v5, v11, v8, v13, v14}, Lnet/lingala/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    .end local v10    # "writeZip64ExtendedInfo":Z
    .local v16, "writeZip64ExtendedInfo":Z
    invoke-virtual {v5, v14, v8, v9, v10}, Lnet/lingala/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V

    .line 444
    iget-object v9, v1, Lnet/lingala/zip4j/headers/HeaderWriter;->longBuff:[B

    invoke-static {v9, v8, v13, v8, v12}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    goto :goto_1

    .line 446
    .end local v16    # "writeZip64ExtendedInfo":Z
    .restart local v10    # "writeZip64ExtendedInfo":Z
    :cond_2
    move/from16 v16, v10

    .end local v10    # "writeZip64ExtendedInfo":Z
    .restart local v16    # "writeZip64ExtendedInfo":Z
    iget-object v9, v1, Lnet/lingala/zip4j/headers/HeaderWriter;->longBuff:[B
    ...
    invoke-virtual {v5, v9, v8, v14, v15}, Lnet/lingala/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    .end local v16    # "writeZip64ExtendedInfo":Z
    .local v9, "writeZip64ExtendedInfo":Z
    invoke-direct {v1, v3, v9}, Lnet/lingala/zip4j/headers/HeaderWriter;->calculateExtraDataRecordsSize(Lnet/lingala/zip4j/model/FileHeader;Z)I

    move-result v10

    .line 451
    .local v10, "extraFieldLength":I
    invoke-virtual {v5, v4, v10}, Lnet/lingala/zip4j/util/RawIO;->writeShortLittleEndian(Ljava/io/OutputStream;I)V
    ...
    .line 454
    .local v12, "fileComment":Ljava/lang/String;
    new-array v14, v8, [B
    ...
    invoke-virtual {v5, v15, v8, v0}, Lnet/lingala/zip4j/util/RawIO;->writeIntLittleEndian([BII)V
    ...
    invoke-virtual {v4, v0, v8, v15}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    ...
    .end local v9    # "writeZip64ExtendedInfo":Z
    .restart local v16    # "writeZip64ExtendedInfo":Z
    ...
    invoke-virtual {v5, v4, v8, v9}, Lnet/lingala/zip4j/util/RawIO;->writeLongLittleEndian(Ljava/io/OutputStream;J)V
    ...
    .line 479
    .end local v16    # "writeZip64ExtendedInfo":Z
    .restart local v9    # "writeZip64ExtendedInfo":Z
    :cond_6
    move/from16 v16, v9
    ...
    invoke-virtual {v5, v4, v8}, Lnet/lingala/zip4j/util/RawIO;->writeShortLittleEndian(Ljava/io/OutputStream;I)V
    ...
    .end local v8    # "aesStrengthBytes":[B
    :cond_7
    ...
    .end local v12    # "fileComment":Ljava/lang/String;
