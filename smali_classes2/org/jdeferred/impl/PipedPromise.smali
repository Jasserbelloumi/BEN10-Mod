...
.method public constructor <init>(Lorg/jdeferred/Promise;Lorg/jdeferred/DonePipe;Lorg/jdeferred/FailPipe;Lorg/jdeferred/ProgressPipe;)V
    ...
    .line 28
    .local p0, "this":Lorg/jdeferred/impl/PipedPromise;, "Lorg/jdeferred/impl/PipedPromise<TD;TF;TP;TD_OUT;TF_OUT;TP_OUT;>;"
    .local p1, "promise":Lorg/jdeferred/Promise;, "Lorg/jdeferred/Promise<TD;TF;TP;>;"
    .local p2, "doneFilter":Lorg/jdeferred/DonePipe;, "Lorg/jdeferred/DonePipe<TD;TD_OUT;TF_OUT;TP_OUT;>;"
    .local p3, "failFilter":Lorg/jdeferred/FailPipe;, "Lorg/jdeferred/FailPipe<TF;TD_OUT;TF_OUT;TP_OUT;>;"
    .local p4, "progressFilter":Lorg/jdeferred/ProgressPipe;, "Lorg/jdeferred/ProgressPipe<TP;TD_OUT;TF_OUT;TP_OUT;>;"
    ...
    new-instance v1, Lorg/jdeferred/impl/PipedPromise$2;

    invoke-direct {v1, p0, p3}, Lorg/jdeferred/impl/PipedPromise$2;-><init>(Lorg/jdeferred/impl/PipedPromise;Lorg/jdeferred/FailPipe;)V

    invoke-interface {v0, v1}, Lorg/jdeferred/Promise;->fail(Lorg/jdeferred/FailCallback;)Lorg/jdeferred/Promise;

    move-result-object v0

    new-instance v1, Lorg/jdeferred/impl/PipedPromise$1;

    invoke-direct {v1, p0, p4}, Lorg/jdeferred/impl/PipedPromise$1;-><init>(Lorg/jdeferred/impl/PipedPromise;Lorg/jdeferred/ProgressPipe;)V
...
.method protected pipe(Lorg/jdeferred/Promise;)Lorg/jdeferred/Promise;
    ...
    .line 55
    .local p0, "this":Lorg/jdeferred/impl/PipedPromise;, "Lorg/jdeferred/impl/PipedPromise<TD;TF;TP;TD_OUT;TF_OUT;TP_OUT;>;"
    .local p1, "promise":Lorg/jdeferred/Promise;, "Lorg/jdeferred/Promise<TD_OUT;TF_OUT;TP_OUT;>;"
